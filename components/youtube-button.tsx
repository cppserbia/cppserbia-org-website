...
export async function YouTubeButton({
  ...
  return (
    <Link
      ...
      className={`inline-flex items-center justify-center gap-2 rounded-lg bg-[#FF0000] text-white transition-colors hover:bg-[#FF0000]/80 ${sizeClasses[size]} ${className}`}

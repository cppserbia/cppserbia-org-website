...
status: PAST
duration: PT4H
end_time: 2024-08-30T22:00:00+02:00
...
Due to the ongoing heat waves, vacation season, and general summer mood, we received feedback from the community that it is challenging to focus on lectures and deep dives into C++ features, developments, and use cases. It seems the perfect time to go outside, touch grass, and connect with nature. This created an initiative to organize another event aimed toward casual C++ conversations, but this time in Košutnjak.

We are preparing a picnic for all community members. Everyone is free to join in, meet people, discuss the release of C++26, have a bite, and cool down with some cold liquid refreshments.

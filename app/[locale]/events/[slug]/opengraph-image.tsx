...
export default async function OgImage({
  ...
  const title = event.title.length > 80 ? event.title.substring(0, 77) + "..." : event.title;
    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center" }}>
          <img src={logoBase64} alt="" width={56} height={56} style={{ borderRadius: 8 }} />
          <span
            style={{
              marginLeft: 16,
              fontSize: 24,
        ...
        >
          <div
            style={{
              ...
              textAlign: "center",
              lineHeight: 1.2,
              backgroundImage: "linear-gradient(to right, #ef4444, #c084fc, #60a5fa)",
              backgroundClip: "text",
              color: "transparent",
              padding: "0 20px",
            }}
        ...
        <div
          style={{
            width: "100%",
            height: 4,
            backgroundImage: "linear-gradient(to right, #ef4444, #a855f7, #3b82f6)",
            borderRadius: 2,
          }}
        />
      </div>
